...
|;*****************************************************************************
	...
	|;Rb : cell
	|;return value
	.macro Get_Cell_Array(Ra, Rb, Rc, Rt){
		MULC(Rb, 4, Rt)	|;Multiply cell by for to obtain offset memory
		ADD(Ra, Rt, Rt)	|;Add offset to pointers of array 
		LD(Rt, 0, Rc)	|;return value of cell
	}
	.macro Set_Cell_Array(Ra, Rb, Rc, Rt){
		MULC(Rb, 4, Rt)	|;Multiply cell by for to obtain offset memory
		ADD(Ra, Rt, Rt)	|;Add offset to pointers of array 
		ST(Rc, 0, Rt)	|;save register
	}
...
perfect_maze:
	...
	Get_Cell_Array(R7, R6, R12, R14)
	SUBC(R5, 1, R12)		|;loaded Register <- curr_cell -1
	Set_Cell_Array(R7, R6, R12, R14)|;save register
	...
	Get_Cell_Array(R7, R6, R12, R14)
	SUBC(R5, 32, R12)		|;loaded Register <- curr_cell - nb_cols
	...
	BEQ(R11, nobottom)
					|;neighbours[n_valid_neighbours++] = curr_cell + nb_cols;
	Get_Cell_Array(R7, R6, R12, R14)
	ADDC(R5, 32, R12)		|;loaded Register <- curr_cell + nb_cols
	Set_Cell_Array(R7, R6, R12, R14)|;save register
	ADDC(R6, 1, R6)			|;n_valid_neighbours++
	nobottom:
	...
	while:
		...
		Get_Cell_Array(R7, R9, R8, R14)
					|;swap(neighbours + n_valid_neighbours - 1, neighbours + random_neigh_index);
		SUBC(R6, 1, R11)
		Get_Cell_Array(R7, R11, R12, R14)
		Get_Cell_Array(R7, R9, R13, R14)
		Set_Cell_Array(R7, R9, R12, R14)
		Set_Cell_Array(R7, R11, R13, R14)
					|;n_valid_neighbours--;		
		SUBC(R6, 1, R6)
